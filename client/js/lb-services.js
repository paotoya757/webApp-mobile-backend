  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Oferta.categoria() instead.
        "prototype$__get__categoria": {
          url: urlBase + "/ofertas/:id/categoria",
          method: "GET"
        },
        ...
        // INTERNAL. Use Categoria.ofertas.findById() instead.
        "::findById::Categoria::ofertas": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/categorias/:id/ofertas/:fk",
          method: "GET"
        },

        // INTERNAL. Use Categoria.ofertas.destroyById() instead.
        "::destroyById::Categoria::ofertas": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/categorias/:id/ofertas/:fk",
        ...
        // INTERNAL. Use Categoria.ofertas.updateById() instead.
        "::updateById::Categoria::ofertas": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/categorias/:id/ofertas/:fk",
        ...
        // INTERNAL. Use Categoria.ofertas() instead.
        "::get::Categoria::ofertas": {
          isArray: true,
          url: urlBase + "/categorias/:id/ofertas",
          method: "GET"
        },

        // INTERNAL. Use Categoria.ofertas.create() instead.
        "::create::Categoria::ofertas": {
          url: urlBase + "/categorias/:id/ofertas",
          method: "POST"
        },

        // INTERNAL. Use Categoria.ofertas.createMany() instead.
        "::createMany::Categoria::ofertas": {
          isArray: true,
          url: urlBase + "/categorias/:id/ofertas",
          method: "POST"
        },

        // INTERNAL. Use Categoria.ofertas.destroyAll() instead.
        "::delete::Categoria::ofertas": {
          url: urlBase + "/categorias/:id/ofertas",
          method: "DELETE"
        },

        // INTERNAL. Use Categoria.ofertas.count() instead.
        "::count::Categoria::ofertas": {
          url: urlBase + "/categorias/:id/ofertas/count",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Oferta";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Oferta#categoria
         * @methodOf lbServices.Oferta
         *
         * @description
         *
        ...
        R.categoria = function() {
          ...
          var action = TargetResource["::get::Oferta::categoria"];
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__findById__accessTokens
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__destroyById__accessTokens
         * @methodOf lbServices.Cliente
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__updateById__accessTokens
         * @methodOf lbServices.Cliente
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__get__accessTokens
         * @methodOf lbServices.Cliente
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__create__accessTokens
         * @methodOf lbServices.Cliente
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__delete__accessTokens
         * @methodOf lbServices.Cliente
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Cliente#prototype$__count__accessTokens
         * @methodOf lbServices.Cliente
         *
         * @description
         *
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Categoria.ofertas
     * @header lbServices.Categoria.ofertas
     * @object
     * @description
     *
     * The object `Categoria.ofertas` groups methods
     * manipulating `Oferta` instances related to `Categoria`.
     *
     * Call {@link lbServices.Categoria#ofertas Categoria.ofertas()}
     ...
     */
        ...
        R.ofertas = function() {
          ...
          var action = TargetResource["::get::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#count
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
         * Counts ofertas of Categoria.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.ofertas.count = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::count::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#create
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
        ...
        R.ofertas.create = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::create::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#createMany
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
        ...
        R.ofertas.createMany = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::createMany::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#destroyAll
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
        ...
        R.ofertas.destroyAll = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::delete::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#destroyById
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
        ...
        R.ofertas.destroyById = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::destroyById::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#findById
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
        ...
        R.ofertas.findById = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::findById::Categoria::ofertas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Categoria.ofertas#updateById
         * @methodOf lbServices.Categoria.ofertas
         *
         * @description
         *
        ...
        R.ofertas.updateById = function() {
          var TargetResource = $injector.get("Oferta");
          var action = TargetResource["::updateById::Categoria::ofertas"];
          return action.apply(R, arguments);
        };
